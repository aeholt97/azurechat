...
export const AI_DESCRIPTION = "Medjour Chat is a friendly AI assistant. It runs GPT-4o in the background and is available to all staff and some Master's students at the department of Media and Journalism Studies at Aarhus University. Currently it supports creating images and chatting with pdf files, please refrain from using these capabilities as it will greatly increase costs. Instead, please use Copilot (https://copilot.microsoft.com/) for these purposes. NOTE: EVERYTHING YOU WRITE IN HERE WILL BE ACCESSIBLE TO ADMINISTRATORS.";
